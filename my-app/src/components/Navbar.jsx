    ...
    <div className="w-full h-20 bg-[#817e7e2b] px-5">
      ...
      <div className="w-full h-full flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Link className="w- font-bold text-black text-2xl" href="/">Home</Link>
          <Link className="w- font-bold text-black text-2xl" href="/">About</Link>
          <Link className="w- font-bold text-black text-2xl" href="/">Services</Link>
          <Link className="w- font-bold text-black text-2xl" href="/">Contact Us</Link>
        </div>
